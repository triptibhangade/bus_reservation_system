...
class SeatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seat" do
    assert_difference('Seat.count') do
      post seats_url, params: { seat: { reservation_id: @seat.reservation_id, seat_no: @seat.seat_no } }
    end
  ...
  test "should update seat" do
    patch seat_url(@seat), params: { seat: { reservation_id: @seat.reservation_id, seat_no: @seat.seat_no } }
